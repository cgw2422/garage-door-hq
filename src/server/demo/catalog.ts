...
export const DEMO_REMEDIES: StarterRemedy[] = [
  ...
  { componentKey: 'opener', name: 'Chain Opener', packageKey: 'opener-chain', sortOrder: 0, forStatuses: ['FAILED', 'NEEDS_ATTENTION'] },
  { componentKey: 'opener', name: 'Belt Opener', packageKey: 'opener-belt', sortOrder: 1, forStatuses: ['FAILED', 'NEEDS_ATTENTION'] },
  { componentKey: 'opener', name: 'Camera Belt Opener', packageKey: 'opener-camera', sortOrder: 2, forStatuses: ['FAILED', 'NEEDS_ATTENTION'] },
  { componentKey: 'opener', name: 'Customer provided Opener', sku: 'FR-OPENER-CUSTOMER', quantity: 1, sortOrder: 3, forStatuses: ['FAILED', 'NEEDS_ATTENTION'] },
